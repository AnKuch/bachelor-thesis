...
\node at (3.75,-0.75) {c$_1$ $\notin$ e$_2$};
\node at (9.5,1.8) {a = revokeOperation};
...
\node at (6,7){c$_1$};
\node at (3.75,5.4) {c$_1$ $\in$ e$_2$};
\node at (3.75,5) {$\wedge$ eType e$_4$ = (CNode $\vee$ Untyped)};
\node at (3.75,4.6) {$\wedge$ c$_2 \in$ cdt c$_1$ s};
\node at (9.5,7.8) {a = revokeOperation}; 
