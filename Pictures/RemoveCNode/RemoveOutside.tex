...
\node at (3.75,-0.75) {c$_2$ $\notin$ e$_4$};
\node at (9.5,1.8) {a = removeOperation};
\node at (9.5,1.4) { e$_4$ c$_2$ c$_1$ t};
...
\node at (6,7){c$_2$};
\node at (3.75,5.4) {c$_2$ $\in$ e$_4$};
\node at (3.75,5) {$\wedge$ eType e$_2$ = (CNode $\vee$ VSpace $\vee$ IContr)};
\node at (9.5,7.8) {a = removeOperation}; 
\node at (9.5,7.4) {e$_4$ c$_2$ c$_1$ s};
