...
My entity type: \\ \\
	...
	entity = & caps :: cap set \\
			 & eValue :: nat 													
	\end{tabular}}} \\ 
I also had to modify the formalisation of the system operations as they should be able to \texttt{read} and \texttt{write} the value of an entity. For that they need a fuction that returns the value of an entity: \\ \\
{\relsize{-1}
\texttt{
