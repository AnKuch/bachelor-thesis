...
\pgfdeclareimage [ width =16 cm ]{RevokeCNode}{Pictures/RevokeCNode/RevokeCNode}
\pgfdeclareimage [ width =16 cm ]{RevokeOthers}{Pictures/RevokeCNode/RevokeOthers}
\pgfdeclareimage [ width =16 cm ]{RevokeOutside}{Pictures/RevokeCNode/RevokeOutside}
\pgfdeclareimage [ width =16 cm ]{RevokeOutside2}{Pictures/RevokeCNode/RevokeOutside2}
