...
\item \texttt{Recycle()} \\
revokes all outstanding capabilities and reconfigures teh object to its initial state. So the object can be reused in for another purpose.
\end{itemize}
	...
	\subsubsection{Memory Allocation Model} %TODO
...
\newpage
\section{Formalisation of the Noninterference Model}
